...
void HorlogeDS3232::lectureHoraireALARM1() {
  m_alarm1Hour =  lectureRegistreEtConversion(ALM1_MATCH_HOURS , 0x3f); // alarme 1 hours
  m_alarm1Minute = lectureRegistreEtConversion(ALM1_MATCH_MINUTES); // alarme 1 minutes
  m_alarm1Second =  lectureRegistreEtConversion(ALM1_MATCH_SECONDS , 0x7f); // alarme 1 seconds
}

///-----lecture horaire ALARM2-----
void HorlogeDS3232::lectureHoraireALARM2() {
  m_alarm2Hour =  lectureRegistreEtConversion(ALM2_MATCH_HOURS , 0x3f); // alarme 2 hours
  m_alarm2Minute = lectureRegistreEtConversion(ALM2_MATCH_MINUTES); // alarme 2 minutes
}
...
// ajout manuel : bool HorlogeDS3232::choixTypeOuvertureFermeture(bool choixOuvertureFermeture, const byte alarme) {
