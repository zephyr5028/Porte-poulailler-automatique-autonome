...
class HorlogeDS3232 : public DS3232RTC
{
  ...
  public:
    ...
    //  bool choixTypeOuverture(bool choixOuverture, const byte alarme); // mise à jour du choix du type d'ouverture
    // bool choixTypeFermeture(bool choixFermeture, const byte alarme); // mise à jour du choix du type de fermeture
